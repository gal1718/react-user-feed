...
import { User } from "../../utils/typeAndData";
import { Link } from "react-router-dom";

function AppBarComp({LoggedUser}: {LoggedUser: User}) {
  ...
  return (
    <div className="AppBarComp">
      <AppBar position="sticky" sx={{ backgroundColor: '#101113',borderBottom: "1px solid gray"}}>
